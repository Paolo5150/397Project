...
public:
	...
	*/
	...
	/**
	* @brief						Add a light to the list
	*
	* @pre							The light manager must exist
	* @post							The light is added to the list
	* @param	l					The light to be added
	*/
	void SubscirbeLight(Light* l);

	/**
	* @brief						Remove light from the list
	*
	* @pre							The light manager must exist
	* @post							The light is removed from the list
...
private:
	...
	*/
	...
	/**
	* @brief						The list of directional lights
	*/
	std::list<DirectionalLight*> alldirectionalLights;

	/**
	* @brief						The list of point lights
	*/
