...
npc1X, npc1Y, npc1Z = 1900,0,1900;

CreateAsset("Model", "Nanosuit");
npc2X, npc2Y, npc2Z = 40,0,30;

CreateAsset("Model", "Nanosuit");
npc3X, npc3Y, npc3Z = 20,0,34;

CreateAsset("Model", "Nanosuit");
npc4X, npc4Y, npc4Z = 11,0,11;

CreateAsset("Model", "Nanosuit");
npc5X, npc5Y, npc5Z = 49,0,17;

CreateAsset("Model", "Nanosuit");
npc6X, npc6Y, npc6Z = 32,0,17;

CreateAsset("Model", "Nanosuit");
npc7X, npc7Y, npc7Z = 10,0,31;

CreateAsset("Model", "Nanosuit");
npc8X, npc8Y, npc8Z = 32,0,38;

CreateAsset("Model", "Nanosuit");
npc9X, npc9Y, npc9Z = 9,0,16;

CreateAsset("Model", "Nanosuit");
npc10X, npc10Y, npc10Z = 8,0,46;

CreateAsset("Model", "Nanosuit");
npc11X, npc11Y, npc11Z = 42,0,32;

CreateAsset("Model", "Nanosuit");
npc12X, npc12Y, npc12Z = 45,0,37;

CreateAsset("Model", "Nanosuit");
npc13X, npc13Y, npc13Z = 26,0,23;

CreateAsset("Model", "Nanosuit");
npc14X, npc14Y, npc14Z = 11,0,45;

CreateAsset("Model", "Nanosuit");
npc15X, npc15Y, npc15Z = 36,0,20;

CreateAsset("Model", "Nanosuit");
npc16X, npc16Y, npc16Z = 49,0,48;

CreateAsset("Model", "Nanosuit");
npc17X, npc17Y, npc17Z = 45,0,12;

CreateAsset("Model", "Nanosuit");
npc18X, npc18Y, npc18Z = 38,0,16;
