...
void ExitScene::Initialize() {
	Core::Instance().GetGraphicsAPI().SetClearColor(0.8f, 0.8f, 0.8f);
	 ...
	 GUIManager::Instance().AddGUIObject(new GUIText("dylanText", "Dylan Green","invasionFont", 40, 60, 0.1f, 0.1f, 0.1f, true));
	 GUIManager::Instance().AddGUIObject(new GUIText("mitchText", "Mitchell Hollings", "invasionFont",70, 60, 0.1f, 0.1f, 0.1f, true));
